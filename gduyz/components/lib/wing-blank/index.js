...
(0, _baseComponent.default)({
    properties: {
        prefixCls: {type: String, value: "wux-wingblank"},
    ...
    }, data: {extStyle: ""}, computed: {
        classes: ["prefixCls, size", function (e, t) {
            return {wrap: (0, _classNames2.default)(e, _defineProperty({}, "".concat(e, "--").concat(t), t))}
        }]
    }
});
