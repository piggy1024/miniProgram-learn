...
Component({
  ...
  methods: {
    ...
    drawCanvas: function () {
      ...
      //画布的部分文字内容在component-share/index.js修改 如第一行个性签名栏.   广告地址也在那
      ...
      //邀请  // nickname = 小猪   invite: 在疯狂打call
      ctx.setFillStyle(NORMAL_COLOR);
      ctx.setFontSize(16);
      ctx.setTextAlign('left'); 
